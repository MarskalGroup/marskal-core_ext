module Marskal
  module CoreExt
    ...
    module MyDate
      ...
      #
      # Gets the most recently passed Monday Date from the given date.
      ...
      #
      # ==== Returns
      # <tt>(Date)</tt> The most recent passed Monday date
      #
      # ==== Examples
      ...
      ##
      # *DEPRECATED:*
      #TODO: make new method in line with rubies method
      ...
      #
      # ==== Examples
      #   "2016-10-12".to_date.start_of_next_month   #=> Tue, 01 Nov 2016
      # ---
      ...
      #   Date.today.formatted().formatted()          #=> "12/11/2016"
      ...
      module ClassMethods
        ...
        ##
        # *DEPRECATED:* No tests were written for this since it should NOT be used anymore.
        ...
        def create_from_string(p_date_str)
          ActiveSupport::Deprecation.deprecation_warning("create_from_string is deprecated", 'use ".to_s" => "10/12/1999".to_s')
        ...
        # end
        # def next_week_on_day(p_day = :monday)
        #   self.start_of_week + 7.days
        # end
